...
class Projects extends Component {
  ...
  render() {
    return (
      ...
      {/* <div className='projectsMoreInfo'>
      <div className='projectCardBelow'>
        <div className='imagewrap'>
          <a
            href='https://taylorpenberthy.github.io/projectOneFinal/'
            target='_blank'
          >
            <img src={screenshot} className='projectImagesBelow' />
          </a>
      ...
      <div className='projectCardBelow'>
        <div className='imagewrap'>
          <a href='https://sounddump.herokuapp.com' target='_blank'>
            <img src={sounddump} className='projectImagesBelow' />
          </a>
        </div>
      ...
      <div className='projectCardBelow'>
        <div className='imagewrap'>
          <a href='' target='_blank'>
            <img src={sounddumpmobile} className='projectImagesBelow' />
          </a>
        </div>
      ...
      <div className='projectCardBelow'>
        <div className='imagewrap'>
          <a href='https://yeetbeer.herokuapp.com' target='_blank'>
            <img src={beer} className='projectImagesBelow' />
          </a>
        </div>
        <div className='overlay'>
          <p>
